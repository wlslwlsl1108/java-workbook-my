...
class Box {
    ...
    Box() {
        ...
        this.width = 1;                    // width 생성자 호출하여 1로 초기화
        this.height = 1;                   // height 생성자 호출하여 1로 초기화
        this.depth = 1;                    // depth 생성자 호출하여 1로 초기화
    }
...
public class Q2 {
    public static void main(String[] args) {
        ...
        System.out.println(b1.width + " " + b1.height + " " + b1.depth);   // b1가 참조하는 w / h / d 출력
        System.out.println(b2.width + " " + b2.height + " " + b2.depth);   // b2가 참조하는 w / h / d 출력
    }
}